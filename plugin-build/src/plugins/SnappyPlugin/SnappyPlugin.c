/* Automatically generated by
   ...
   from
	SnappyPlugin Snappy-Plugin-mu.34 uuid: 69233896-03e2-0040-ae03-ef29168f111a
 */
static char __buildInfo[] = "SnappyPlugin Snappy-Plugin-mu.34 uuid: 69233896-03e2-0040-ae03-ef29168f111a " __DATE__ ;
...
EXPORT(void) primitiveMaskedCrc32c(void);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SnappyPlugin Snappy-Plugin-mu.34 (i)"
#else
	"SnappyPlugin Snappy-Plugin-mu.34 (e)"
#endif
;
...
charPointerFor(sqInt obj)
{
	...
	ptr = ((char*) (interpreterProxy->firstIndexableField(obj)));
	return ptr;
}
...
l3:	/* end stackPositiveIntegerValue: */;
	...
	ptr1 = ((char*) (interpreterProxy->firstIndexableField(obj)));
	output = ptr1;
...
l4:	/* end stackPositiveIntegerValue: */;
	...
	ptr1 = ((char*) (interpreterProxy->firstIndexableField(compressedObj)));
	compressed = ptr1;
...
l4:	/* end stackPositiveIntegerValue: */;
	...
	ptr1 = ((char*) (interpreterProxy->firstIndexableField(uncompressedObj)));
	uncompressed = ptr1;
l2:	/* end charPointerFor: */;
	if (!(uncompressed)) {
		interpreterProxy->primitiveFail(); return;
...
void* SnappyPlugin_exports[][3] = {
	...
	{"SnappyPlugin", "primitiveMaskedCrc32c", (void*)primitiveMaskedCrc32c},
